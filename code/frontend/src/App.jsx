    ...
    <div className="relative min-h-screen pt-24 pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <PricingCard title="Modelo Premium" icon={<Crown size={32} className="text-purple-400" />} description="Ecossistema completo de vendas e CRM." delay="200" color="purple" price="R$1099,90" subPrice="" onHire={() => openContactModal('Modelo Premium')}>
             <ul className="space-y-4 text-sm text-gray-300 mb-8">
