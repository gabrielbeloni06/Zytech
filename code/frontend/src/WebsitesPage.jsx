                            ...
                            <div className="grid gap-6">
                                {tiers.map((tier) => (
                                    <div 
                                        ...
                                        className={`group relative p-6 rounded-2xl bg-black/40 border border-white/5 cursor-pointer transition-all hover:bg-black/60 flex items-center justify-between gap-6 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] ${colorStyles[tier.color].borderHover}`}
                                    >
                                        <div className={`p-4 rounded-xl transition-colors ${colorStyles[tier.color].iconBg} ${colorStyles[tier.color].iconColor} ${colorStyles[tier.color].hoverBg} group-hover:text-white`}>
                                            {tier.icon}
                                        </div>
